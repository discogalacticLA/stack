...
export const RELEASES: SeedRelease[] = [
  {
    ...
    editions: [
      {
        key: "nb-orig", label: "Lowlight Recordings", catno: "LLR-004", format: "Vinyl", details: '12", 33 ⅓ RPM', country: "GB", year: 1997, month: 3,
        ...
        identifiers: [["matrix_runout", "LLR-004-A  ◇ LOW ◇", "side A, etched"], ["matrix_runout", "LLR-004-B", "side B, etched"], ["label_code", "LC 0000 (synthetic)"]],
      ...
      {
        key: "nb-repress", label: "Lowlight Recordings", catno: "LLR-004R", format: "Vinyl", details: '12", 33 ⅓ RPM, Repress', country: "GB", year: 2004,
        ...
        identifiers: [["matrix_runout", "LLR-004R-A", "side A"], ["matrix_runout", "LLR-004R-B RE", "side B"]],
        sources: [["physical_copy", "Seller photo of runout (synthetic source)"]],
        images: ["front"],
      },
      {
        key: "nb-cd", label: "Lowlight Recordings", catno: "LLR 004 CD", format: "CD", details: "EP, Enhanced", country: "GB", year: 1997, month: 5,
    ...
    editions: [
      {
        ...
        identifiers: [["matrix_runout", "LLR-04-A  MASTERED BY H.S.", "side A"]],
        sources: [["physical_copy", "Moderator examined a copy (synthetic source)"]],
        images: ["front"],
      },
      {
        key: "tr-de", label: "Heliotrope Audio", catno: "HEL 012", format: "Vinyl", details: '12", 33 ⅓ RPM, Licensed', country: "DE", year: 1999,
  ...
  },
  {
    ...
    editions: [{ key: "ut", label: "Basement Signal", catno: "BSG-007", format: "Vinyl", details: '12"', country: "DE", year: 2003, status: "sourced", tracks: [["A", "Theory One", "7:30"], ["B1", "Theory Two", "6:45"], ["B2", "Loop Study", "3:20"]], sources: [["physical_copy", "Synthetic source"]], images: ["front"] }],
  },
  {
    ...
    editions: [
      { key: "sm", label: "Heliotrope Audio", catno: "HEL-021", format: "Vinyl", details: '12", Clear vinyl', country: "JP", year: 2010, status: "reviewed", tracks: [["A1", "Soft Machines", "9:10"], ["B1", "At Dawn", "8:02"]], sources: [["physical_copy", "Synthetic source"]], images: ["front"] },
  ...
  },
  {
    ...
    genres: ["Electronic"],
    styles: ["House", "Disco"],
    editions: [{ key: "tl", label: "Cobalt Room", catno: "CBR-001", format: "Vinyl", details: '12", 45 RPM', country: "NL", year: 1995, status: "sourced", notes: "No archive image contributed yet.", tracks: [["A", "Tram Lines", "6:30"], ["B", "Tram Lines (Late Service)", "7:15"]], sources: [["publication", "Synthetic fanzine review, 1995"]] }],
  },
  {
    ...
    editions: [{ key: "ot", label: null, catno: null, format: "Cassette", details: "C60, Self-released", country: "MX", year: null, dateNote: "Believed to be early 1990s; no date on the inlay.", status: "unverified", tracks: [] }],
  },
  {
    title: "Relay / Return",
    type: "single",
    ...
    genres: ["Electronic"],
    styles: ["Techno"],
    editions: [{ key: "rr", label: "Basement Signal", catno: "BSG-012", format: "Vinyl", details: '12"', country: "DE", year: 2005, status: "sourced", tracks: [["A", "Relay", "6:50"], ["B", "Return", "6:35"]], sources: [["physical_copy", "Synthetic source"]], images: ["front"] }],
  },
  {
    title: "Vale",
    type: "album",
    ...
    editions: [{ key: "va", label: "Heliotrope Audio", catno: "HEL-030", format: "Vinyl", details: "LP", country: "GB", year: 2012, status: "reviewed", tracks: [["A1", "Valley", "5:12"], ["A2", "Glassline", "6:01"], ["B1", "Hollow", "5:44"], ["B2", "Vale", "7:20"]], sources: [["label_statement", "Synthetic label statement"]], images: ["front", "back"] }],
  },
  {
    title: "Assembly Hall",
    type: "ep",
    ...
    genres: ["Electronic"],
    styles: ["House", "Garage"],
    editions: [{ key: "ah", label: "Cobalt Room", catno: "CBR-009", format: "Vinyl", details: '12"', country: "NL", year: 1999, status: "sourced", tracks: [["A1", "Assembly Hall", "6:40"], ["B1", "Choir Loft", "6:10"], ["B2", "Hall Dub", "5:50"]], sources: [["physical_copy", "Synthetic source"]], images: ["front"] }],
  },
  {
    ...
    editions: [{ key: "wt", label: "Lowlight Recordings", catno: "LLR-022", format: "Vinyl", details: '12"', country: "GB", year: 2008, status: "reviewed", tracks: [["A1", "Tool One", "5:30"], ["A2", "Tool Two", "5:02"], ["B1", "Tool Three", "6:15"], ["B2", "Tool Four", "4:48"]], sources: [["physical_copy", "Synthetic source"]], images: ["front"] }],
  },
  {
    title: "Deep Weather",
    type: "album",
    ...
    editions: [
      { key: "dw", label: "Lowlight Recordings", catno: "LLR-011", format: "Vinyl", details: "2×LP", country: "GB", year: 2000, status: "reviewed", tracks: [["A1", "Front", "6:00"], ["B1", "Pressure", "6:30"], ["C1", "Squall", "7:10"], ["D1", "Clearing", "5:50"]], sources: [["label_statement", "Synthetic release sheet"]], images: ["front"] },
      { key: "dw-cd", label: "Lowlight Recordings", catno: "LLR-011CD", format: "CD", country: "GB", year: 2000, status: "sourced", tracks: [["1", "Front", "6:00"], ["2", "Pressure", "6:30"], ["3", "Squall", "7:10"], ["4", "Clearing", "5:50"], ["5", "Isobar", "6:44"]], sources: [["website", "Synthetic source"]], images: ["front"] },
    ],
  },
  {
    title: "Mar Aberto",
    ...
    editions: [{ key: "ma", label: "Tidewater Tapes", catno: "TWT-30", format: "Vinyl", details: '12"', country: "BR", year: 2016, status: "sourced", tracks: [["A", "Mar Aberto", "7:02"], ["B", "Mar Aberto (Instrumental)", "7:00"]], sources: [["artist_statement", "Synthetic source"]], images: ["front"] }],
  },
];
