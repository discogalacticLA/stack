...
1. **Branding.** The name is **Stacks** (decided 2026-09-25). Still open: logo and visual identity, and a trademark/domain check (not done).
...
> You're working on "Stacks", a local TypeScript/Express/SQLite
